...
class InvitationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create invitation" do
    assert_difference('Invitation.count') do
      post invitations_url, params: { invitation: { attended_event_id: @invitation.attended_event_id, attendee_id: @invitation.attendee_id } }
    end
  ...
  test "should update invitation" do
    patch invitation_url(@invitation), params: { invitation: { attended_event_id: @invitation.attended_event_id, attendee_id: @invitation.attendee_id } }
